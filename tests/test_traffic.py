...
def test_both_cars_move_forward_no_collisions(car1_road, car2_road, car1_expected_road, car2_expected_road):
...
def test_two_cars_no_collisions_first_turns_right(car1_road, car2_road, car1_expected_road, car2_expected_road):
...
def test_two_cars_no_collision_second_turn_right(car1_road, car2_road, car1_expected_road, car2_expected_road):
...
def test_two_cars_forward_with_collisions_car1_moves_first(car1_road, car2_road, car1_expected_road,
                                                           car2_expected_road):
...
def test_two_cars_forward_with_collisions_car2_moves_first(car1_road, car2_road, car1_expected_road,
                                                           car2_expected_road):
    actions = [(1, Action.FORWARD, False),
               (2, Action.FORWARD, False)]
...
def test_two_cars_collisions_first_forward_second_turn_left(car1_road, car2_road, car1_expected_road,
                                                            car2_expected_road):
    actions = [(1, Action.FORWARD, False),
               (2, Action.LEFT, False)]
...
def test_two_cars_collisions_first_turns_left_second_forward(car1_road, car2_road, car1_expected_road,
                                                             car2_expected_road):
